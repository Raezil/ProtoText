...
func (s *Server) SampleProtected(ctx context.Context, in *ProtectedRequest) (*ProtectedReply, error) {
...
func (s *Server) Register(ctx context.Context, in *RegisterRequest) (*RegisterReply, error) {
